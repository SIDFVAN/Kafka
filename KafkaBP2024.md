...
bash /opt/kafka/bin/kafka-topics.sh --bootstrap-server 172.16.0.3:9093 --create --topic newtopic --partitions 2 --replication-factor 2 --command-config /opt/kafka/config/kraft/admin.config